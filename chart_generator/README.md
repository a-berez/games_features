...
- `-t`, `--table` — создание дополнительного HTML-файла с интерактивной таблицей
...
#### Использование с созданием таблицы
```chart_generator.py 12345 -t```
...
> [!IMPORTANT]
> В корневой директории проекта (в примере ниже это `charts` должна быть папка `work`, в которой должны обязательно находиться файлы стилей и скриптов.

Скрипт создает следующую структуру файлов:
```
charts/
├──work/
│   ├── chart_generator_styles.css   # файл стиля
│   └── chart_generator_scripts.js    # файл скриптов
├── ID_турнира_или_имя_файла/
│   ├── ID_турнира_или_имя_файла_chart.html    # Основной файл с графиком
│   ├── ID_турнира_или_имя_файла_table.html    # Основной файл с таблицей
│   ├── ID_турнира_или_имя_файла.csv    # csv файл для работы интерактивной таблицы
│   └── extra/                           # Дополнительные файлы по флагам
│       ├── ID_турнира_или_имя_файла_4_chart.html
│       ├── ID_турнира_или_имя_файла_4_table.html
│       ├── ID_турнира_или_имя_файла_4.csv
│       ├── ID_турнира_или_имя_файла_4OR7_chart.html
│       ├── ID_турнира_или_имя_файла_4OR7_table.html
│       ├── ID_турнира_или_имя_файла_4OR7.csv
│       └── ...
```
