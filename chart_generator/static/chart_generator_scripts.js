// Инициализируем replay-таблицу, если она есть на странице
if (typeof replayTable !== 'undefined' && document.querySelector('.replayTable')) {
    replayTable.magic();
}

// Добавляем скрипт для дополнительного центрирования и адаптивности
if (document.querySelector('.replayTable')) {
